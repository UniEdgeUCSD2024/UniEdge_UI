  ...
  function InternshipDetails() {
    ...
    const handleMockInterview = async () => {
      try {
        ...
        const resume = resumeResponse.data.resume_text; // Assuming resume is in resume_text field
              ...
              <>
                ...
                <div className='me-4'>
                  ...
                  <Form.Select
                    ...
                    value={selectedType}
                    className='job-type-select' // Add a class for custom styling
                  >
                    {[
                      'DataAnalyst',
                      'BusinessAnalyst',
                    ...
                    <Container className='p-4 mb-1'>
                      <div className='d-flex justify-content-between align-items-start'>
                        <div className='flex-column'>
                          <p className='fw-semibold mb-1'>{jobDetails.company_name}</p> {/* Changed to fw-semibold for semi-bold */}
  ...
  const JobCard = ({ job, selected }) => {
    return (
      <Card
        className={`shadow-none p-2 ${selected ? 'border border-1' : 'border-bottom border-0 rounded-0'}`}
        style={{
          cursor: 'pointer',
      ...
      >
        <CardBody>
          {/* Semi-bold company name */}
          <p className='fw-semibold mb-4'>{job.company_name}</p> {/* Changed from fw-light to fw-semibold */}
